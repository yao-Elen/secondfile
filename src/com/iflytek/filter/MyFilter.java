...
@WebFilter(filterName = "MyFilter", servletNames = {"login", "logout"}, urlPatterns = {"/count.jsp"}, initParams = {@WebInitParam(name = "count", value = "0"), @WebInitParam(name = "encoding", value = "Utf-8")})
